...
if IsDuplicityVersion() then 
    RegisterServerCallback("GetPlayerPermission",function(source,cb)
    ...
    Command["freecam"] = function()
        TriggerServerCallback("GetPlayerPermission",function(allow)
            if allow then 
                exports['nb-freecam']:TriggerFreeCamera()
            end 
        end)
    end
end